...
public:
	...
	gueepo::math::vec2 endPosition;

	Shadow() : start(0.0f), end(0.0f) {}
	Shadow(float _start, float _end, gueepo::math::vec2 _startPosition, gueepo::math::vec2 _endPosition) : start(_start), end(_end), startPosition(_startPosition), endPosition(_endPosition) {}
